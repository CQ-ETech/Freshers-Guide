  ...
  return (
    <div className="min-h-screen pb-20 overflow-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center py-20 px-4 text-center z-10 animate-fade-in">
        <Image src="/LOGO.png" alt="Communiqué Logo" width={110} height={110} className="mb-6 w-24 h-24 sm:w-28 sm:h-28 rounded-full shadow-lg border-4 border-[#FFD600] bg-[#181818]" />
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-[#FFF700] via-[#FFD600] to-[#FFB300] drop-shadow-lg font-comfortaa">
          About Communiqué
        </h1>
        <p className="text-lg sm:text-xl md:text-2xl text-[#FFF8E4] max-w-3xl mx-auto font-comfortaa mb-6">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-10 items-stretch animate-fade-in-up">
        <div className="bg-[#232323]/80 backdrop-blur-md rounded-2xl shadow-xl p-6 md:p-8 flex flex-col items-center border border-[#FFD600]/20 glassmorphism-card min-h-[320px] min-w-0 w-full">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#FFD600] font-comfortaa">Our Vision</h2>
          <p className="text-base md:text-lg text-[#FFF9E3] font-comfortaa">
        ...
        <div className="bg-[#232323]/80 backdrop-blur-md rounded-2xl shadow-xl p-6 md:p-8 flex flex-col items-center border border-[#FFD600]/20 glassmorphism-card min-h-[320px] min-w-0 w-full">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#FFD600] font-comfortaa">Our Mission</h2>
          <p className="text-base md:text-lg text-[#FFF9E3] font-comfortaa">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 animate-fade-in-up">
        <h2 className="text-3xl sm:text-4xl font-bold text-[#FFD600] mb-10 text-center font-comfortaa">Events Conducted by Communiqué</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {communiqueEvents.map((item) => (
            <div key={item.title} className="bg-[#232323]/80 backdrop-blur-md rounded-2xl shadow-2xl p-6 sm:p-8 flex flex-col items-center hover:scale-105 hover:shadow-yellow-400/30 transition-transform duration-300 border border-[#FFD600]/20 glassmorphism-card">
              {item.icon}
              <h3 className="text-xl sm:text-2xl font-semibold text-[#FFEA00] mb-2 font-comfortaa text-center">{item.title}</h3>
              <p className="text-[#FFF8E4] text-sm sm:text-base font-comfortaa text-center">{item.description}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 animate-fade-in-up">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-10 gap-8 md:gap-0">
          <h2 className="flex-1 text-4xl sm:text-5xl md:text-7xl font-extrabold text-[#FFD600] text-center md:text-left font-comfortaa mb-6 md:mb-0 leading-tight md:leading-[1.1] md:pl-16 tracking-wider">
            Meet Our Team
          </h2>
          <div className="flex justify-center md:justify-end w-full md:w-auto">
            <div className="flex flex-col items-center bg-[#181818]/90 rounded-xl shadow-2xl p-6 sm:p-8 max-w-xs border border-[#FFD600]/20 hover:scale-110 hover:shadow-yellow-400/40 transition-transform duration-300 glassmorphism-card group">
              ...
              <p className="text-sm sm:text-base font-comfortaa text-center group-hover:text-[#FFEA00]">{executiveTeam[0].role}</p>
            </div>
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 justify-items-center">
          {executiveTeam.slice(1).map((member) => (
            <div key={member.name} className="flex flex-col items-center bg-[#181818]/90 rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-xs border border-[#FFD600]/20 hover:scale-110 hover:shadow-yellow-400/40 transition-transform duration-300 glassmorphism-card group">
              <FaUserTie className="text-[#FFD600] text-4xl mb-4 group-hover:rotate-12 transition-transform duration-300" />
              <h3 className="text-xl font-semibold text-[#FFEA00] mb-1 font-comfortaa text-center group-hover:text-[#FFD600]">{member.name}</h3>
              <p className="text-sm sm:text-base font-comfortaa text-center group-hover:text-[#FFEA00]">{member.role}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Call to Action */}
      <div className="mt-16 text-[#FFD600] text-base md:text-lg font-comfortaa text-center animate-fade-in-up px-4">
