      ...
      <section className="relative flex flex-col items-center justify-center px-2 sm:px-4 py-8 text-center w-full max-w-7xl mx-auto animate-fade-in min-h-[40vh]">
        <div className="relative z-10 flex flex-col gap-20 w-full items-stretch">
          ...
          <div className="flex flex-col md:flex-row items-center md:justify-between gap-10 md:gap-20">
            ...
            <FadeInOnScroll delay={50} className="leading-relaxed text-[#FFF9E3] text-lg sm:text-2xl md:text-3xl font-semibold text-left max-w-2xl md:max-w-3xl md:self-center drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] font-comfortaa">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:justify-between gap-10 md:gap-20">
            ...
            <FadeInOnScroll delay={100} className="leading-relaxed text-[#FFF9E3] text-lg sm:text-2xl md:text-3xl font-semibold text-center md:text-left max-w-2xl md:max-w-3xl md:self-center drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] font-comfortaa">
          ...
          <div className="flex flex-col md:flex-row items-center md:justify-between gap-10 md:gap-20">
            ...
            <div className="flex flex-col items-center md:items-end w-full">
              <FadeInOnScroll delay={150} className="leading-relaxed text-[#FFF9E3] text-lg sm:text-2xl md:text-3xl font-semibold mb-6 text-left max-w-2xl md:max-w-3xl md:self-center drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] font-comfortaa">
