        ...
        <div className="relative z-10 flex flex-col gap-12 sm:gap-16 md:gap-20 w-full items-stretch">
          ...
          <div className="p-8 bg-gradient-to-br from-gray-900 via-black to-gray-950 rounded-2xl shadow-2xl  shadow-yellow-500/10 border  border-[#FFD700]/20 hover:shadow-yellow-400/10 transition-all duration-300">
            ...
            <h3 className="mt-8 text-xl text-left font-light text-[#D1D5DB]">
              ...
              <ul className="list-disc ml-8 mt-2">
                <li>
                  <span className="font-semibold">Sports Meet:</span> The Inter
                  IIT includes a wide range of sports events, such as athletics,
                  football, basketball, cricket, badminton, and more.
                </li>
                <br />

                <li>
                  <span className="font-semibold">Cultural Meet:</span> In
                  addition to sports, the Inter IIT also includes cultural
                  events, allowing students to showcase their talents in music,
                  dance, drama, and other artistic forms.
                </li>
                <br />

                <li>
                  <span className="font-semibold">Technical Meet:</span> The
                  Inter IIT also features technical competitions, where students
                  can participate in coding challenges, robotics contests, and
