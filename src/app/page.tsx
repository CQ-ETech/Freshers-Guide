  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <section className="relative flex flex-col items-center justify-center px-4 sm:px-6 py-16 sm:py-24 text-center w-full max-w-4xl mx-auto animate-fade-in min-h-[40vh] mt-4 mb-10 sm:mb-16">
        ...
        <Link href="/profiles" className="inline-block px-6 sm:px-8 py-3 bg-[#FFD600] text-[#181818] font-semibold rounded-lg shadow-lg hover:bg-[#FFB300] hover:text-white focus:outline-none focus:ring-4 focus:ring-[#FFD600]/40 transition-all duration-300 text-base sm:text-lg tracking-wide mt-4 border border-[#FFB300]/60 font-comfortaa">
          Explore Profiles
        </Link>
      </section>
      {/* 3 Vertical Sections */}
      <section className="relative flex flex-col items-center justify-center px-2 sm:px-4 py-8 sm:py-12 text-center w-full max-w-7xl mx-auto animate-fade-in min-h-[40vh]">
