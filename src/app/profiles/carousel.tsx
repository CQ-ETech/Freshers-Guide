...
const Carousel = ({ data }: CarouselProps) => {
  ...
  return (
    <div className="carousel text-center jusitfy-center pt-10 pb-[100px]">
        ...
        <section className="flex w-[90vw] md:w-[65vw] h-[450px] md:h-[500px] items-center overflow-hidden relative">
          ...
          {data.map(
            (profile) =>
              topId === profile.id && (
                <motion.section
                  className={`h-full w-full rounded-lg ${profile.bgColor} absolute`}
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 0.3 }}
            ...
            !isClicked
              ? topId === profile.id && (
                  ...
                  >
                    ...
                    <section
                      className={`body-text absolute bottom-[0px] left-[0px] overflow-hidden text-left p-4 ${profile.textCol} font-semibold`}
                    >
                      <motion.h3
                        className="text-base md:text-lg overflow-hidden pb-4"
                        animate={{
                          x: [
                            0,
                            0,
                      ...
                      <Link
                        href={profile.href}
                        className="underline text-base md:text-lg hover:no-underline"
                      >
                        Read More
                      </Link>
                    </section>
      ...
      <div
        className={`carousel-navigation cursor-pointer flex flex-wrap justify-center`}
      >
