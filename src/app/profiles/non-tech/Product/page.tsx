...
<div className="absolute -top-8 left-6 sm:left-1/2 transform -translate-x-1/2 px-6 py-2 bg-[#bfa600] text-black font-bold rounded-full shadow-lg">START</div>
          ...
          {steps.map((step, idx) => (
            ...
            >
              <div className="relative w-full sm:max-w-md">
                <div className={`absolute top-1/2 -translate-y-1/2 -left-10 sm:${idx % 2 === 0 ? '-left-16' : '-right-16'} w-14 h-14 rounded-full bg-black border-4 flex items-center justify-center shadow-lg`} style={{ borderColor: '#bfa600' }}>
                  {step.icon}
                </div>
                <motion.div
          ...
          <div className="absolute -bottom-8 left-6 sm:left-1/2 transform -translate-x-1/2 px-6 py-2 bg-[#bfa600] text-black font-bold rounded-full shadow-lg">FINISH</div>
