...
const steps = [
  {
    stage: "Start",
    heading: "Understand the Industry Landscape",
    desc: "Begin by exploring various consulting branches like management, strategy, IT, and HR. Read reports by top consulting firms and learn about real-world consulting engagements.",
    icon: <MdOutlineStart size={24} />,
    color: "cyan",
  },
  {
    stage: "Explore",
    heading: "Build Domain Expertise",
    desc: "Identify industries of interest—like healthcare, tech, or energy—and deep dive into business models, market trends, and major players to gain a consultant’s perspective.",
    icon: <MdOutlineSchool size={24} />,
    color: "amber",
  },
  {
    stage: "Skills",
    heading: "Develop Soft & Communication Skills",
    desc: "Consultants must communicate ideas clearly. Practice public speaking, storytelling, slide-making, and structured problem-solving to convey strategic recommendations effectively.",
    icon: <MdOutlineChecklist size={24} />,
    color: "rose",
  },
  {
    stage: "Frameworks",
    heading: "Master Frameworks & Tools",
    desc: "Learn structured frameworks like SWOT, 5 Forces, BCG Matrix, and tools like Excel, PowerPoint, Notion, and Miro to structure and visualize your analysis.",
    icon: <MdOutlineChecklist size={24} />,
    color: "blue",
  },
  {
    stage: "Practice",
    heading: "Crack Consulting Cases",
    desc: "Engage in mock case interviews with peers. Use resources like Case in Point, Victor Cheng, and PrepLounge to simulate real consulting problems.",
    icon: <MdOutlineWorkOutline size={24} />,
    color: "emerald",
  },
  {
    stage: "Network",
    heading: "Find Mentors & Connect",
    desc: "Reach out to alumni in consulting, join LinkedIn communities, and attend virtual events or consulting club meets to understand recruitment and culture.",
    icon: <MdOutlineChecklist size={24} />,
    color: "green",
  },
  {
    ...
    desc: 'Pursue consulting-oriented courses like Coursera’s "Business Strategy", or certifications in project management, analytics, or digital transformation.',
    icon: <MdOutlineVerified size={24} />,
    color: "yellow",
  },
  {
    stage: "Showcase",
    heading: "Build Your Consulting Persona",
    desc: "Write blog posts, build a portfolio of solved cases, publish frameworks on LinkedIn, or run a mock consulting project with friends or local businesses.",
...
const opportunities = [
  {
    ...
    detail:
      "Engage with companies to redesign workflows, enter new markets, or improve profitability. Often involves travel and client interaction.",
    icon: <FaUserTie size={32} />,
  },
  {
    title: "IT Consulting",
    detail:
      "Focus on implementing and advising on tech systems—cloud, cybersecurity, ERP—working closely with tech and operations teams.",
    icon: <FaTools size={32} />,
  },
  {
    title: "Strategy Consulting",
    detail:
      "Offer long-term advisory on mergers, market entry, or corporate strategy. Requires deep research, quantitative skills, and industry knowledge.",
    icon: <FaRegLightbulb size={32} />,
  },
  {
    title: "HR Consulting",
    detail:
      "Help firms with workforce planning, change management, performance evaluations, or learning and development programs.",
    icon: <FaHandshake size={32} />,
  },
  {
    title: "Freelance Consulting",
    detail:
      "As a freelancer, assist startups or NGOs in solving specific business problems or building their strategic roadmap with independence and flexibility.",
    ...
    <main className="font-comfortaa relative bg-transparent text-yellow-100 min-h-screen py-16 sm:py-24 px-4 sm:px-12 overflow-hidden">
      ...
      <section className="relative max-w-6xl mx-auto">
        <div className="relative flex flex-col items-center">
          ...
          <div className="absolute -top-8 left-6 sm:left-1/2 transform -translate-x-1/2 px-6 py-2 bg-yellow-500 text-black font-bold rounded-full shadow-lg">
            START
          </div>
              ...
              >
                ...
                <div className="absolute left-6 sm:left-1/2 transform -translate-x-1/2">
                  <div
                    ...
                    style={{
                      borderColor: `var(--tw-border-${step.color}-500)`,
                    }}
                  >
                    {step.icon}
                  </div>
          ...
          <div className="absolute -bottom-8 left-6 sm:left-1/2 transform -translate-x-1/2 px-6 py-2 bg-yellow-500 text-black font-bold rounded-full shadow-lg">
            FINISH
          </div>
        </div>
      </section>
