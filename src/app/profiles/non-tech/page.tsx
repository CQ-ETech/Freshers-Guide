...
const data = [
  {
    ...
    bgColor: "bg-[#736146]",
    bottomGradient:
      "bg-gradient-to-b from-[#736146]/30 via-[#635437] to-[#53472d]",
  ...
  },
  {
    ...
    bgColor: "bg-[#3e413c]",
    bottomGradient:
      "bg-gradient-to-b from-gray-300/30 via-gray-400 to-gray-500",
    textCol: "text-gray-200",
    navCol: "text-gray-400",
    strokeColor: "gray",
  ...
  },
  {
    ...
    bgColor: "bg-[#e5cdb1]",
    bottomGradient:
      "bg-gradient-to-t from-brown-500 via-brown-400 to-brown-300",
    textCol: "text-gray-200",
    navCol: "text-gray-400",
    strokeColor: "gray",
